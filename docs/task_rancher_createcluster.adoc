...
TIP: Pour plus d'informations sur les conditions requises pour la création de clusters, reportez-vous au https://rancher.com/docs/rancher/v2.x/en/cluster-provisioning/["Documentation de l'éleveur"^] .
...
* Vous vous êtes familiarisé avec les exigences répertoriées dans le https://rancher.com/docs/rancher/v2.x/en/cluster-provisioning/["Documentation de l'éleveur"^].
