...
TIP: Voir link:../media/hseries-isi.pdf["affiche"^]pour une représentation visuelle des instructions.
...
Dans le cas des H610C, les termes « nœud » et « châssis » sont utilisés de manière interchangeable, parce que les nœuds et les châssis ne sont pas des composants distincts, contrairement au châssis 2U à quatre nœuds.

Voici une illustration de l'installation du nœud/châssis sur le rack :

image::h610c_chassis.png[Affiche le nœud/châssis H610C en cours d'installation dans le rack.]
...
image:blue circle.png["point bleu"] Pour les ports D et E, connectez deux câbles ou émetteurs-récepteurs SFP28/SFP+ pour une gestion partagée, des machines virtuelles et une connectivité de stockage.

image:purple circle.png["point violet"] (Facultatif, recommandé) Connectez un câble CAT5e au port IPMI pour une connectivité de gestion hors bande.
...
image:green circle.png["point vert"] Pour les ports A et B, connectez deux câbles CAT5e ou supérieur aux ports A et B pour la connectivité de gestion.

image:orange circle.png["point orange"] Pour les ports C et F, connectez deux câbles ou émetteurs-récepteurs SFP28/SFP+ pour la connectivité des machines virtuelles.

image:blue circle.png["point bleu"] Pour les ports D et E, connectez deux câbles ou émetteurs-récepteurs SFP28/SFP+ pour la connectivité de stockage.

image:purple circle.png["point violet"] (Facultatif, recommandé) Connectez un câble CAT5e au port IPMI pour une connectivité de gestion hors bande.

Voici le câblage du nœud H410S :

image::HCI_ISI_storage_cabling.png[Affiche le câblage du nœud H410S.]

image:green circle.png["point vert"] Pour les ports A et B, connectez deux câbles CAT5e ou supérieur aux ports A et B pour la connectivité de gestion.

image:blue circle.png["point bleu"] Pour les ports C et D, connectez deux câbles ou émetteurs-récepteurs SFP28/SFP+ pour la connectivité de stockage.
...
NOTE: Les nœuds H610C sont déployés uniquement dans la configuration à deux câbles. Assurez-vous que tous les VLAN sont présents sur les ports C et D.

image::H610C_node-cabling.png[Affiche le câblage du nœud H610C.]
...
image:light blue circle.png["point bleu clair"] Connectez les deux câbles d'alimentation au nœud et branchez les câbles d'alimentation sur une prise 200 V.
...
image::H615C_node_cabling.png[Affiche le câblage du nœud H615C.]
...
image:light blue circle.png["point bleu clair"] Connectez les deux câbles d'alimentation au nœud et branchez les câbles d'alimentation sur une prise 110 V.
...
TIP: Pour ajouter des nœuds de calcul H410C, l'installation existante doit exécuter NetApp HCI 1.4 ou version ultérieure. Pour ajouter des nœuds de calcul H615C, l'installation existante doit exécuter NetApp HCI 1.7 ou version ultérieure.
...
. Connectez-vous à l'aide du nom d'utilisateur `root` et du mot de passe `calvin`.
